...
file = open('gsearch_jobs.csv', encoding="utf8")
 
# Reading the contents of the gsearch_jobs.csv file
contents = csv.reader(file)
 
# SQL query to insert data into the da_data table
insert_records = "INSERT INTO da_data (title, company_name,location,via,description,work_from_home,salary_hourly,salary_yearly,salary_standardized) VALUES(?, ?, ?,?,?,?,?,?,?)"
